## trendminer_interface.objects.Fingerprint

Bases: `SavedItemBase`

Fingerprint work organizer object

Attributes:

| Name         | Type                    | Description                                                          |
| ------------ | ----------------------- | -------------------------------------------------------------------- |
| `definition` | `FingerprintDefinition` | Definition of the fingerprint, containing all configuration details. |
...
| Type      | Description                                   |
| --------- | --------------------------------------------- |
| `Monitor` | The monitor associated with this fingerprint. |
