## trendminer_interface.objects.TrendHubView

Bases: `SavedItemBase`

Trend hub view work organizer object

Attributes:

| Name         | Type                     | Description                                                             |
| ------------ | ------------------------ | ----------------------------------------------------------------------- |
| `definition` | `TrendHubViewDefinition` | Definition of the trend hub view, containing all configuration details. |
