# `client.notebook.pipeline`

## trendminer_interface.\_client.notebook.pipeline.PipelineFacade

Bases: `WorkFacadeBase[Pipeline]`

Facade for getting saved pipeline objects
