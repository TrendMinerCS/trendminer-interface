# `client.search.similarity`

## trendminer_interface.\_client.search.similarity.SimilaritySearchFacade

Bases: `WorkFacadeBase[SimilaritySearch]`

Facade for getting saved similarity search objects
